package rs.ac.uns.ftn.informatika.udd.vezbe03.lucene.indexing.handlers.xml;
...
import rs.ac.uns.ftn.informatika.udd.vezbe03.lucene.indexing.analysers.SerbianAnalyzer;
...
public class XMLIndexer {
	...
	public static void main(String[] args) {
		...
		try{
			if (args.length != 2) {
				ResourceBundle rb=ResourceBundle.getBundle("rs.ac.uns.ftn.informatika.udd.vezbe03.lucene.test.luceneindex");
