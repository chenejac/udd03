...
import rs.ac.uns.ftn.informatika.udd.vezbe03.lucene.indexing.Indexer;
import rs.ac.uns.ftn.informatika.udd.vezbe03.lucene.model.IndexUnit;
import rs.ac.uns.ftn.informatika.udd.vezbe03.lucene.model.UploadModel;
	    ...
	    private void indexUploadedFile(UploadModel model) throws IOException{
	    	...
	    	for (MultipartFile file : model.getFiles()) {
	            ...
	            if(fileName != null){
	            	...
	            	Indexer.getInstance().add(indexUnit);
	            }
	    	}
	    }
